  ...
  return (
    ...
    <div className="flex justify-center">
      <div className="w-[1428px] h-[1230px] mb-8 my-10">
        ...
        <h6 className='flex justify-center font-[Helvetica Neue] text-[32px] pt-6 text-[rgba(17,17,17,1)] leading-[36px] font-medium'>GET HELP</h6>
        <div className='flex justify-center relative'><input type="text" placeholder="What can we help you with?" className='w-[457.33px] h-[56px] text-[15px] pl-4 leading-[24px] font-normal rounded-[8px] border-2 border-gray-400' /><Search width={15.1} height={15} className="relative top-5 right-8 text-[rgba(141,141,141,1)]" /></div>
        </div>
        ...
        <div className="flex justify-center w-[1309px] h-[1098px]">
            ...
            <h6 className="font-[Helvetica Neue] text-[28px] leading-[32px] text-[rgba(17,17,17,1)] font-medium pt-10">WHAT PAYMENT OPTIONS CAN I USE ON NIKE ORDERS?</h6>
            ...
            <div className="space-x-4 pb-5">
                <Button className="w-[106.13px] h-[39px] rounded-full font-[Helvetica Neue] text-[16px] leading-[24px] font-medium">JOIN US</Button>
                <Button className="w-[129.84px] h-[39x] rounded-full font-[Helvetica Neue] text-[16px] leading-[24px] font-medium">SHOP NIKE</Button>
            </div>

            <h3 className="font-[Helvetica Neue] font-medium text-[20px] text-[rgba(17,17,17,1)] leading-[24px] pb-5">FAQs</h3>
                  
                  <div>
            <p className="font-[Helvetica Neue] font-semibold text-[16px] text-[rgba(17,17,17,1)] leading-[28px]">Does my card need international purchases enabled?</p>
            <p className="font-[Helvetica Neue] font-normal text-[16px] text-[rgba(17,17,17,1)] leading-[28px]">Yes, we recommend asking your bank to enable international purchases on your card. You will be notified at checkout </p>
            <p className="font-[Helvetica Neue] font-normal text-[16px] text-[rgba(17,17,17,1)] leading-[28px] pb-5">if international purchases need to be enabled.</p>
                  </div>
            
            <p className="font-[Helvetica Neue] font-normal text-[15px] text-[rgba(17,17,17,1)] leading-[28px] pb-6">Please note, some banks may charge<span className="font-[Helvetica Neue] font-semibold text-[15px] text-[rgba(17,17,17,1)] leading-[28px]"> a small transaction fee</span> for international orders.</p>
            ...
            <div>
              <p className="font-[Helvetica Neue] font-semibold text-[15px] text-[rgba(17,17,17,1)] leading-[28px]">What payment method is accepted for SNKRS orders?</p>
              <p className="font-[Helvetica Neue] font-normal text-[15px] text-[rgba(17,17,17,1)] leading-[28px] pb-5">You can use any accepted credit card to pay for your SNKRS order.</p>
            </div>
