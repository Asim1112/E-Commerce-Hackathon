...
<div className="w-[440px] h-[386px]">
    ...
    <h6 className="font-[Helvetica Neue] text-[21px] leading-[24px] font-semibold pb-3">
      How would you like to get your order?</h6>
    <p className="font-[Helvetica Neue] text-[16px] text-[rgba(117,117,117,1)] leading-[24px] font-normal pb-9">
      ...
      for more information. <span className="font-[Helvetica Neue] text-[15px] text-[rgba(117,117,117,1)] 
      leading-[24px] font-normal underline">Learn More</span></p>
    <Button variant="ghost" className="w-[440px] h-[82px] flex justify-start gap-6 border-2 font-[Helvetica Neue] 
...
<div className="w-[440px] h-[1504px]">
  ...
  <p className='font-[Helvetica Neue] text-[21px] leading-[24px] font-medium py-5'>Enter your name and address:</p>
  
  <div className="flex flex-col gap-6">
    
    <input type="text" placeholder="First Name" className="w-[440px] h-[56px] placeholder-black rounded-lg
     leading-[24px] font-[Helvetica Neue] text-[16px] font-normal pl-4 border-2 border-gray-300" />
    ...
    <input type="text" placeholder="Postal Code" className="w-[211.19px] h-[56px]
     placeholder-black rounded-lg leading-[24px] font-[Helvetica Neue] text-[16px] font-normal pl-4 border-2
     border-gray-300" /><input type="text" placeholder="Locality" className="w-[211.19px] h-[56px]
     placeholder-black rounded-lg leading-[24px] font-[Helvetica Neue] text-[16px] font-normal pl-4
       border-2 border-gray-300" />
    </div>
    
    <div className="flex justify-between">
    <input type="text" placeholder="State/Territory" className="w-[211.19px]
     h-[56px] placeholder-black rounded-lg leading-[24px] font-[Helvetica Neue] text-[16px] font-normal pl-4
...
<div className='flex flex-col gap-8 pt-1'>
    ...
    <span className="ml-3 font-[Helvetica Neue] font-normal text-[15px] leading-[24px] text-[rgba(17,17,17,1)]">
    ...
    <label className="flex items-center"><span className="w-[20px] h-[20px] rounded-sm bg-gray-300 border
     border-gray-300"></span><span className="ml-3 font-[Helvetica Neue] font-medium text-[15px] leading-[24px]
  ...
  <p className='font-[Helvetica Neue] text-[21px] leading-[24px] font-medium mt-5'>What&apos;s your contact information?</p>
  <input type="text" placeholder="Email" className="w-[440px] h-[56px] placeholder-black rounded-lg leading-[24px]
   font-[Helvetica Neue] text-[16px] font-normal pl-4 border-2 border-gray-300" />
  
  <p className='font-[Helvetica Neue] text-[11px] leading-[24px] pl-4 text-[rgba(117,117,117,1)]'>
  ...
  <div className='w-[440px] h-[256px] flex flex-col gap-4 mt-6'>
  <p className='font-[Helvetica Neue] text-[21px] leading-[24px] font-medium mt-5'>What&apos;s your PAN?</p>
  
  <input type="text" placeholder="PAN" className="w-[440px] h-[56px] placeholder-black rounded-lg leading-[24px]
   font-[Helvetica Neue] text-[16px] font-normal pl-4 border-2 border-gray-300" />
  
  <p className='w-[376.3px] h-[48px] font-[Helvetica Neue] text-[12px] leading-[24px] pl-4
   text-[rgba(117,117,117,1)]'>Enter your PAN to enable payment with UPI, Net Banking or local card methods</p>
  
  <label className="flex items-center">
  <input type="checkbox" className='w-[18px] h-[18px] rounded-sm border border-gray-200 p-4'/>
  <span className="ml-3 font-[Helvetica Neue] font-normal text-[12px] leading-[24px]
  ...
  <span className="ml-3 font-[Helvetica Neue] font-normal text-[12px] leading-[14px]
...
<p className='font-[Helvetica Neue] text-[21px] leading-[24px] font-medium py-5'>Order Summary</p>
...
<div className='font-[Helvetica Neue] text-[15px] py-2 leading-[16px] text-[rgba(141,141,141,1)] flex justify-between'>
  ...
  <div className='font-[Helvetica Neue] font-medium text-[15px] leading-[16px] flex justify-between py-4'>
    ...
    <hr />
  <p className='text-[9px] leading-[24px] pt-2'>(The total reflects the price of your order, including all duties and
     taxes)</p>
  ...
  <div className='w-[320px] h-[208px]flex flex-col gap-2'>
    ...
    <p className='font-inter text-[13px]'><p className='font-normal leading-[24px]'>Nike Dri-FIT ADV TechKnit Ultra Men's Short-Sleeve Running Top</p><p className='leading-[19.6px] text-[rgba(141,141,141,1)]'>Qty 1</p><p className='leading-[19.6px] text-[rgba(141,141,141,1)]'>Size L</p><p className='leading-[19.6px] text-[rgba(141,141,141,1)]'>₹ 3 895.00</p></p>
      </div>
  </div>
