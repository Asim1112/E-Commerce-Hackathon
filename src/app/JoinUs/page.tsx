...
const page = () => {
  ...
  <p className='w-[282.8px] h-[60px] px-1 font-[Helvetica Neue] text-[14px] text-[rgba(141,141,141,1)]
  ...
  <label htmlFor="password"></label><input type="password" id="password" placeholder="Last Name"
   ...
   font-normal font-[Helvetica Neue] pl-4" />
  
  <div className="pb-2">
  <label htmlFor="password"></label><input type="password" id="password" placeholder="Date of Birth" 
   className="w-[324px] h-[40px] rounded-[3px] border border-gray-300 text-[14px] leading-[17px] font-normal
   font-[Helvetica Neue] pl-4" />
  <p className="font-[Helvetica Neue] text-[11px] text-[rgba(141,141,141,1)] font-normal leading-[13.31px]
  ...
  <label className="flex items-center"><input type="checkbox" className='w-[35px] h-[35px] rounded-[3px] border
   border-gray-300'/><span className="ml-3 font-[Helvetica Neue] font-medium text-[12px] leading-[14px]
  ...
  <p className="text-[12px] leading-[16px] font-medium font-[Helvetica Neue]
   ...
   className='hover:text-blue-500 transition-colors duration-300'>Terms of Use.</a></span></p>
    ...
    <Button className="w-[324px] h-[40px] rounded-[3px] text-[15px] leading-[17px] font-normal font-[Helvetica Neue]
     text-white">JOIN US</Button>
    <div className="flex justify-center items-center gap-1"><p className="font-[Helvetica Neue] text-[11px]
     leading-[14px] font-normal text-[rgba(141,141,141,1)]">Already a Member?</p>
     <span className="font-[Helvetica Neue] underline text-[11px] leading-[14px] font-normal">
