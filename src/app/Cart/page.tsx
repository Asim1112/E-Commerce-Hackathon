    ...
    <div className="w-[1411px] h-[680px] flex justify-center">
        ...
        <div className="w-[717.33px] h-[62.89px] bg-[rgba(247,247,247,1)]">
            <div className="flex flex-col justify-center h-full pl-6">
                ...
                <p className="font-[Helvetica Neue] font-light text-[11px] leading-[24px]">Applies to orders of ₹ 14 000.00 or more. <span className="font-[Helvetica Neue] ml-3 font-medium text-[11px] leading-[24px] underline solid"><a href="#" className="hover:text-blue-500 transition-colors duration-300">View details</a></span></p>
            </div>
        </div>
                ...
                <div className='w-[537.33px] h-[112px] mt-1 ml-7'>
                    <div className="w-[537.33px] flex justify-between">
                        ...
                        <div className="w-[167.39px] h-[28px] flex justify-between">
                            ...
                            <p className="font-[Helvetica Neue] text-[rgba(117,117,117,1)] font-normal text-[15px] leading-[28px]">Quantity <span className="font-[Helvetica Neue] text-[rgba(117,117,117,1)] font-normal ml-1 text-[14px] leading-[28px]">1</span></p>
                        </div>
        ...
        <hr className="w-[717.33px] h-[2px] mt-6"/>          
                    ...
                    <div className="flex items-center justify-center"><Button className="w-[334.67px] h-[60px] rounded-full font-[Helvetica Neue]">Member Checkout</Button></div>
